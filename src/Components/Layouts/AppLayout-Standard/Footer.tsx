      ...
      <div className="footer__content container">
        <div className="footer__grid">
          ...
          <div className="footer__brand">
            <Link to="/" className="footer__logo">
              <span className="footer__logo-text">CS</span>
              <span className="footer__logo-subtext">Portfolio</span>
            </Link>
            <p className="footer__description">
              Leidenschaftlicher Entwickler mit Fokus auf moderne Webtechnologien 
              und außergewöhnliche Benutzererfahrungen.
            </p>
          </div>
          ...
          <div className="footer__section">
            <h3 className="footer__section-title">Folge mir</h3>
        ...
        <div className="footer__bottom">
          ...
          <p className="footer__made-with">
            Made with <span className="footer__heart">❤️</span> in Germany
          </p>
        </div>
      </div>
    </footer>
